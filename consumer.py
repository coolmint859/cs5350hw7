...
def save_to_s3(logger, widget_obj, bucket_name) -> None:
...
def save_to_dynamodb(logger, widget_obj, table_name) -> None:
    pass
...
def cli(request_bucket, widget_bucket, dynamodb_table, max_wait_time):
